//class responsible for the fraction object
public class Fraction {
    ...
    //checks if the fraction has the same numerator and denominator as the other fraction and returns true if they are. Also increments count to record how many of a kind are there.
