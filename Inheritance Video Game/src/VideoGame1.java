...
//        FivePointedStar s4 = new FivePointedStar(randX(),randY(),50, Color.MAGENTA);
        ...
        Snowman s1 = new Snowman(randX(), randY(), 50);
        Circle s2 = new Circle(randX(), randY(),50, Color.GREEN);
        Polygon s3 = new Polygon(randX(), randY(), 40, 12, Color.MAGENTA);
        TriangleStar s4 = new TriangleStar(randX(), randY(), 50, 5, Color.BLUE);
    ...
    private static void runAllTest() {
        ...
        printTestResult("default circle radius", c1.getRadius() == Circle.DEFAULT_RADIUS);
        Circle c2 = new Circle(0, 0, 12);
        printTestResult("circle area", c2.getArea() == Math.PI * 144);
    ...
    private static void printTestResult(String testName, boolean isPassed) {
        System.out.println("TEST " + testName + ": " + (isPassed ? "PASSED" : "FAILED"));
    }
